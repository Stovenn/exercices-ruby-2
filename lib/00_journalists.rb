...
game = "Y"
  ...
  while game =~ /\y/i 
    puts "Bienvenue, veuillez choisir une question, ou appuyez sur 0 pour quitter"
    puts "\n"
    ...
    when 0
      ...
      puts "Attention veuillez sélectionner une question disponible !"
    end
    puts "\n"
